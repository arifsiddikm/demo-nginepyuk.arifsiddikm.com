...
@section('page_title', isset($property) ? 'Edit Properti' : 'Tambah Properti')
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="form-group mb-0">
                        ...
                        <select name="status" class="form-select" required>
                            <option value="active" {{ old('status', $property->status ?? 'active') === 'active' ? 'selected' : '' }}>Aktif</option>
                    ...
                    <div class="form-group mb-0">
                        ...
                        <input type="number" name="max_guests" value="{{ old('max_guests', $property->max_guests ?? 2) }}" class="form-input" min="1">
                    </div>
                </div>
            </div>
        ...
        <div class="space-y-5">
            <div class="card p-6">
                ...
                <p class="text-xs text-slate-400 mt-1">JPG/PNG/WebP, maks. 4MB</p>
            </div>
            <div class="card p-6">
                <h3 class="font-bold text-slate-700 mb-4 border-b pb-3">Galeri Foto</h3>
                <input type="file" name="images[]" accept="image/*" multiple class="form-input">
                <p class="text-xs text-slate-400 mt-1">Multiple file diizinkan</p>
            </div>
            <div class="card p-6">
                <button type="submit" class="btn btn-primary w-full justify-center py-3">
                    <i class="fas fa-save"></i> {{ isset($property) ? 'Simpan Perubahan' : 'Tambah Properti' }}
                </button>
